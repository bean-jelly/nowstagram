...
from flask import render_template,redirect, request, flash, get_flashed_messages, json, send_from_directory
...
def upload():
    ...
    #http:/werkzeug.pocoo.org/docs/0.10/datastrictires/
    #需要对文件进行裁剪等操作
    file_ext = ''
